...
#include "GLMInc.h"
#include "runtime/code/util/MemoryUtils.h"
...
namespace DynastyEngine
{
    ...
    template<typename T> class TiledBuffer : public Buffer<T> 
    {
    public:
    ...
    template<typename T>class MortonBuffer : public Buffer<T> 
    {
    public:
        void initLayout() override 
        {
    ...
    template<typename T>std::shared_ptr<Buffer<T>> Buffer<T>::makeDefault(size_t w, size_t h) 
    {
    ...
    template<typename T>std::shared_ptr<Buffer<T>> Buffer<T>::makeLayout(size_t w, size_t h, BufferLayout layout) 
    {
        std::shared_ptr<Buffer<T>> ret = nullptr;
        switch (layout) 
        {
