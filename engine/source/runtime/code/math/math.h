...
#include "runtime/code/math/random.h"
...
namespace DynastyEngine
{
    ...
    */
    ...
    public:
        ...
        static glm::mat4
        makeViewMatrix(const glm::vec3& position, const Quaternion& orientation, const glm::mat4* reflect_matrix = nullptr);

        static glm::mat4
        makeLookAtMatrix(const glm::vec3& eye_position, const glm::vec3& target_position, const glm::vec3& up_dir);

        static glm::mat4 makePerspectiveMatrix(Radian fovy, float aspect, float znear, float zfar);
