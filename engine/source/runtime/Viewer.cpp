...
namespace DynastyEngine
{
    ...
    bool Viewer::create(GLFWwindow* window, int width, int height, int outTexId) 
    {
        cleanup();
    ...
    bool Viewer::loadShaders(ShaderProgram &program, ShadingModel shading) 
    {
    ...
    size_t Viewer::getShaderProgramCacheKey(ShadingModel shadingModel, std::set<std::string> shaderDefines) 
    {
        size_t seed = 0;
