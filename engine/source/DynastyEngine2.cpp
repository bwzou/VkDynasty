...
// void DynastyEngine::framebufferResizeCallback(GLFWwindow* window, int width, int height) {
//         auto app = reinterpret_cast<DynastyEngine*>(glfwGetWindowUserPointer(window));
...
//     DynastyEngine::createDepthResources();
//     DynastyEngine::createTextureImage();
//     DynastyEngine::createTextureImageView();
//     DynastyEngine::createTextureSampler();
//     DynastyEngine::loadModel();
//     DynastyEngine::createVertexBuffer();
//     DynastyEngine::createIndexBuffer();
//     DynastyEngine::createUniformBuffers();
//     DynastyEngine::createDescriptorPool();
//     DynastyEngine::createDescriptorSets();
//     DynastyEngine::createCommandBuffers();
...
// void DynastyEngine::recreateSwapChain() {
...
// void DynastyEngine::createTextureImage() {
...
// void DynastyEngine::createTextureImageView() {
//     textureImageView = createImageView(textureImage, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_ASPECT_COLOR_BIT);
// }


// void DynastyEngine::createTextureSampler() {
...
// VkImageView DynastyEngine::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags) {
...
// void DynastyEngine::createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory) {
...
// void DynastyEngine::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout) {
...
// void DynastyEngine::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
//         VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
// void DynastyEngine::createUniformBuffers() {
...
// VkCommandBuffer DynastyEngine::beginSingleTimeCommands() {
...
// void DynastyEngine::endSingleTimeCommands(VkCommandBuffer commandBuffer) {
...
// void DynastyEngine::createCommandBuffers() {
...
// void DynastyEngine::createDepthResources() {
...
// VkFormat DynastyEngine::findSupportedFormat(const std::vector<VkFormat>& candidates, VkImageTiling tiling, VkFormatFeatureFlags features) {
...
// VkFormat DynastyEngine::findDepthFormat() {
...
// bool DynastyEngine::hasStencilComponent(VkFormat format) {
...
// void DynastyEngine::cleanupSwapChain() {
